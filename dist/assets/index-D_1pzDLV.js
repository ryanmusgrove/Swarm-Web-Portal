(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`7.0.4`,t=`v${e}`,n={amber:{ui:`#f59e0b`,uiDim:`rgba(245,158,11,0.2)`,uiBorder:`#78350f`,flames:[`#78350f`,`#b45309`,`#f59e0b`,`#fef3c7`]},green:{ui:`#22c55e`,uiDim:`rgba(34,197,94,0.2)`,uiBorder:`#14532d`,flames:[`#14532d`,`#16a34a`,`#22c55e`,`#bbf7d0`]},blue:{ui:`#3b82f6`,uiDim:`rgba(59,130,246,0.2)`,uiBorder:`#1e3a8a`,flames:[`#1e3a8a`,`#2563eb`,`#60a5fa`,`#ffffff`]},pink:{ui:`#ec4899`,uiDim:`rgba(236,72,153,0.2)`,uiBorder:`#831843`,flames:[`#831843`,`#be185d`,`#ec4899`,`#fce7f3`]}},r=`amber`,i=`standby`,a=!1,o=!1,s=[];function c(e){let t=document.getElementById(e);if(!t)throw Error(`Missing required element: ${e}`);return t}var l=c(`layer-off`),u=c(`layer-terminal`),ee=c(`layer-swarm`),te=c(`layer-os`),ne=c(`terminal-text`),re=c(`loading-bar-container`),ie=c(`swarm-container`),d=c(`mini-display`),f=document.getElementById(`power-switch`),ae=c(`ascii-logo`),oe=new Map;function se(e){e===`apps-folder`?ce():e===`docs-folder`?ue():e===`docs-viewer`?launchDocsViewer():e===`particle-lab`?launchParticleLab():e===`sysmon`?Ye():e===`resource-router`?launchResourceRouter():e===`bee-sim`?launchBeeSim():e===`crypt-vault`?Ze(`CRYPT_VAULT`):e===`jack-in`&&Ze(`JACK_IN`)}function ce(){pe(`layer-apps-folder`),document.getElementById(`layer-apps-folder`).style.display=`block`}function le(){document.getElementById(`layer-apps-folder`).style.display=`none`,he(`layer-apps-folder`)}function ue(){pe(`layer-docs-folder`),document.getElementById(`layer-docs-folder`).style.display=`block`}function de(){document.getElementById(`layer-docs-folder`).style.display=`none`,he(`layer-docs-folder`)}function fe(){f&&f.addEventListener(`click`,Be),te&&te.addEventListener(`click`,e=>{let t=e.target.closest(`[data-app-action]`);t&&se(t.dataset.appAction)});let e=document.getElementById(`layer-apps-folder`);e&&e.addEventListener(`click`,e=>{let t=e.target.closest(`[data-folder-app]`);if(!t)return;let n=t.dataset.folderApp;le(),se(n)});let t=document.getElementById(`layer-docs-folder`);t&&t.addEventListener(`click`,e=>{let t=e.target.closest(`[data-folder-doc]`);if(!t)return;let n=t.dataset.folderDoc;de(),launchDocsViewer(n)}),document.addEventListener(`keydown`,ye)}function pe(e){let t=document.activeElement;t instanceof HTMLElement&&t!==document.body?oe.set(e,t):oe.delete(e)}function me(e){if(!(e instanceof HTMLElement)||!document.contains(e)||e.hasAttribute(`disabled`)||e.hasAttribute(`hidden`))return!1;let t=window.getComputedStyle(e);return t.display===`none`||t.visibility===`hidden`?!1:e.getClientRects().length>0}function he(e){let t=oe.get(e);oe.delete(e),me(t)&&t.focus({preventScroll:!0})}function p(e){let t=document.getElementById(e);return t?window.getComputedStyle(t).display!==`none`:!1}function ge(){for(let e of[`layer-placeholder`,`layer-docs-viewer`,`layer-resource-router`,`layer-sysmon`,`layer-beesim`,`layer-particle-lab`,`layer-docs-folder`,`layer-apps-folder`])if(p(e))return document.getElementById(e);return null}function _e(e){let t=[`a[href]`,`area[href]`,`button:not([disabled])`,`input:not([disabled]):not([type="hidden"])`,`select:not([disabled])`,`textarea:not([disabled])`,`[tabindex]:not([tabindex="-1"])`].join(`,`);return Array.from(e.querySelectorAll(t)).filter(e=>{if(e.hasAttribute(`hidden`))return!1;let t=window.getComputedStyle(e);return t.display===`none`||t.visibility===`hidden`?!1:e.getClientRects().length>0})}function ve(e){if(e.key!==`Tab`)return!1;let t=ge();if(!t)return!1;let n=_e(t);if(n.length===0)return t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus(),e.preventDefault(),!0;let r=n[0],i=n[n.length-1],a=document.activeElement;return!t.contains(a)||!e.shiftKey&&a===i?(r.focus(),e.preventDefault(),!0):e.shiftKey&&a===r?(i.focus(),e.preventDefault(),!0):!1}function ye(e){if(!ve(e)&&e.key===`Escape`){if(m){je(),e.preventDefault();return}if(p(`layer-placeholder`)){Qe(),e.preventDefault();return}if(p(`layer-docs-viewer`)&&typeof closeDocsViewer==`function`){closeDocsViewer(),e.preventDefault();return}if(p(`layer-resource-router`)&&typeof closeResourceRouter==`function`){closeResourceRouter(),e.preventDefault();return}if(p(`layer-sysmon`)){Xe(),e.preventDefault();return}if(p(`layer-beesim`)&&typeof closeBeeSim==`function`){closeBeeSim(),e.preventDefault();return}if(p(`layer-particle-lab`)&&typeof closeParticleLab==`function`){closeParticleLab(),e.preventDefault();return}if(p(`layer-docs-folder`)){de(),e.preventDefault();return}p(`layer-apps-folder`)&&(le(),e.preventDefault())}}var be=[`BIOS Date 04/12/2077 14:32:01 Ver ${e}`,`CPU: Kiroshi Optic-Core 9.2GHz`,`Memory Test: 1048576K OK`,`Initializing Neural Interface...`,`Allocating Core Arena... [64MB OK]`,`Enforcing 64-Byte SIMD Alignment... [STRICT]`,`Initializing MPSC Job Queues... [LOCK-FREE]`,`Mounting VFS... [OK]`,`Loading Subroutines... [OK]`,`<span style='color:#eab308;font-weight:bold;'>HIVE PROTOCOL INITIATED.</span>`,`Deploying Swarm OS...`,`Initiating visual payload...`];function xe(){s.forEach(clearTimeout),s=[]}function Se(e,t){let n=setTimeout(e,t);return s.push(n),n}function Ce(e){let t=n[e];t&&(r=e,document.documentElement.style.setProperty(`--primary`,t.ui),document.documentElement.style.setProperty(`--primary-dim`,t.uiDim),document.documentElement.style.setProperty(`--primary-border`,t.uiBorder),o&&a&&Ge())}var we=!1;function Te(){we=!we,document.body.classList.toggle(`light-mode`,we);let e=document.getElementById(`mode-icon`);e&&(e.innerHTML=we?`&#9788;`:`&#9790;`)}var m=!1,Ee=!1;async function De(e,t,n){let r=new AbortController,i=setTimeout(()=>r.abort(),n);try{return await fetch(e,{...t,signal:r.signal})}finally{clearTimeout(i)}}function Oe(){let e=document.getElementById(`bug-report-title`),t=document.getElementById(`bug-report-desc`);return e!=null&&e.value.length>0||t!=null&&t.value.length>0}function ke(){if(m)return;let e=document.getElementById(`plab-controls`);e&&!e.classList.contains(`collapsed`)&&e.classList.add(`collapsed`);let t=document.getElementById(`beesim-controls`);t&&!t.classList.contains(`collapsed`)&&t.classList.add(`collapsed`);let n=document.getElementById(`bug-report-panel`),r=document.getElementById(`bug-report-btn`);n&&(n.style.display=`flex`,n.offsetHeight,n.classList.add(`open`),r&&r.classList.add(`active`),m=!0,h(`bug-report-title`,`bug-title-count`,60),h(`bug-report-desc`,`bug-desc-count`,250))}function Ae(){let e=document.getElementById(`bug-report-panel`),t=document.getElementById(`bug-report-btn`);if(!e)return;let n=e.querySelector(`.bug-report-confirm`);n&&n.remove(),e.classList.remove(`open`),t&&t.classList.remove(`active`),m=!1;let r=document.getElementById(`bug-report-title`),i=document.getElementById(`bug-report-desc`);r&&(r.value=``),i&&(i.value=``),h(`bug-report-title`,`bug-title-count`,60),h(`bug-report-desc`,`bug-desc-count`,250),setTimeout(()=>{m||(e.style.display=`none`)},350)}function je(){Oe()?Me():Ae()}function Me(){let e=document.getElementById(`bug-report-panel`);if(!e||e.querySelector(`.bug-report-confirm`))return;let t=document.createElement(`div`);t.className=`bug-report-confirm`,t.innerHTML=`
    ...
    `,e.appendChild(t),t.querySelector(`#bug-confirm-discard`).addEventListener(`click`,()=>{Ae()}),t.querySelector(`#bug-confirm-keep`).addEventListener(`click`,()=>{t.remove()})}function Ne(){!o||!a||(m?je():ke())}function h(e,t,n){let r=document.getElementById(e),i=document.getElementById(t);r&&i&&(i.textContent=r.value.length+` / `+n)}function Pe(){let e=document.getElementById(`bug-report-title`),t=document.getElementById(`bug-report-desc`);e&&e.addEventListener(`input`,()=>h(`bug-report-title`,`bug-title-count`,60)),t&&t.addEventListener(`input`,()=>h(`bug-report-desc`,`bug-desc-count`,250))}function Fe(){let e=document.createElement(`canvas`),t=e.getContext(`webgl`)||e.getContext(`experimental-webgl`);if(!t)return`Unknown (WebGL unavailable)`;let n=t.getExtension(`WEBGL_debug_renderer_info`);return n?t.getParameter(n.UNMASKED_RENDERER_WEBGL)||`Unknown`:`Unknown (renderer info unavailable)`}function Ie(e){let t=`═`.repeat(36),n=e=>`║`+e.padEnd(36)+`║`;return[`╔`+t+`╗`,n(`      BUG REPORT UPLINKED`),`╠`+t+`╣`,n(``),n(`   »» TICKET: `+e.toUpperCase()+` ««`),n(``),n(`      STATUS: ACKNOWLEDGED`),n(`      ROUTE:  SWARM CENTRAL`),`╚`+t+`╝`].join(`
`)}function Le(e){let t=()=>{e.value=``,e.removeEventListener(`focus`,t),e.removeEventListener(`keydown`,t)};e.addEventListener(`focus`,t,{once:!0}),e.addEventListener(`keydown`,t,{once:!0})}async function Re(){if(Ee)return;let e=document.getElementById(`bug-report-title`),t=document.getElementById(`bug-report-desc`),n=document.getElementById(`bug-report-send`),r=document.getElementById(`telemetry-toggle`);if(!e.value.trim()||!t.value.trim())return;Ee=!0,n.textContent=`UPLINKING...`,n.disabled=!0;let i=!!r?.checked,a={title:e.value.trim(),description:t.value.trim(),includeTelemetry:i};i&&(a.gpuInfo=Fe());try{let n=await De(`/api/report-bug`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(a)},1e4);if(!n.ok){let e=await n.json().catch(()=>null);throw Error(e?.error||`Uplink failed`)}let r=await n.json();e.value=``,t.value=Ie(r.id??`UNKNOWN`),Le(t)}catch(e){t.value=`[ ERR :: UPLINK FAILED ]
> Transmission interrupted.
> Details: `+(e instanceof Error&&e.name===`AbortError`?`Uplink timed out`:e instanceof Error?e.message:typeof e==`string`?e:`Unknown error`)}finally{Ee=!1,n.textContent=`SEND`,n.disabled=!1}}function ze(e){i=e;let t=document.getElementById(`ice-status`),n=document.getElementById(`sentinel-status`),r=document.getElementById(`stealth-status`);t&&(t.textContent=`STANDBY`,t.className=`status-standby`),n&&(n.textContent=`STANDBY`,n.className=`status-standby`),r&&(r.textContent=`STANDBY`,r.className=`status-standby`),e===`iceburn`&&t?(t.textContent=`[ ACTIVE ]`,t.className=`status-iceburn-pulse`):e===`sentinel`&&n?(n.textContent=`[ ACTIVE ]`,n.className=`status-sentinel`):e===`ghost`&&r&&(r.textContent=`[ CLOAKED ]`,r.className=`status-ghost`),o&&a&&Ge()}function Be(){o=!o,f&&f.setAttribute(`aria-pressed`,o?`true`:`false`),o?(f.classList.add(`on`),He()):(f.classList.remove(`on`),typeof closeParticleLab==`function`&&closeParticleLab(),typeof closeResourceRouter==`function`&&closeResourceRouter(),typeof closeBeeSim==`function`&&closeBeeSim(),typeof closeDocsViewer==`function`&&closeDocsViewer(),m&&Ae(),de(),le(),Xe(),Qe(),Ve())}function Ve(){xe(),a=!1,f&&f.setAttribute(`aria-pressed`,`false`),l.style.display=`flex`,u.style.display=`none`,ee.style.display=`none`,te.style.display=`none`,d.classList.remove(`active`),ne.innerHTML=``,re.style.display=`none`,ie.innerHTML=``,d.innerHTML=``,ae.style.display=`none`,document.getElementById(`protocol-selector`).value=`standby`,i=`standby`}function He(){l.style.display=`none`,u.style.display=`flex`,Se(()=>{ae.style.display=`block`},200);let e=600;be.forEach((t,n)=>{Se(()=>{let e=document.createElement(`div`);e.innerHTML=t,ne.appendChild(e),n===8&&(re.style.display=`block`)},e),e+=250}),Se(()=>{u.style.display=`none`,We()},e+800)}function Ue(e,t,n,r,i,a,o){for(let s=0;s<t;s++){let t=document.createElement(`div`);t.className=`flame-shard`,t.style.backgroundColor=n,t.style.left=`${Math.random()*100}%`,t.style.width=`${2+Math.random()*10}%`,t.style.height=`${a+Math.random()*(o-a)}%`,t.style.zIndex=i,t.style.animationDuration=`${r+Math.random()}s`,t.style.animationDelay=`${Math.random()*2}s`,e.appendChild(t)}}function We(){ee.style.display=`block`,ie.innerHTML=``;for(let e=0;e<80;e++){let e=document.createElement(`div`);e.className=`bee`,e.style.top=`${Math.random()*100}%`,e.style.animationDuration=`${2+Math.random()*3}s, ${.1+Math.random()*.3}s`,e.style.animationDelay=`${Math.random()*3}s, 0s`,e.style.transform=`scale(${.5+Math.random()})`,ie.appendChild(e)}Se(()=>{ee.style.display=`none`,Ke()},5e3)}function Ge(){if(d.innerHTML=``,i===`iceburn`){let e=n[r].flames;Ue(d,20,e[0],1.5,1,60,100),Ue(d,25,e[1],1.2,2,40,80),Ue(d,30,e[2],.8,3,20,60),Ue(d,15,e[3],.5,4,10,40)}else if(i===`sentinel`)for(let e=0;e<20;e++){let e=document.createElement(`div`);e.className=`sentinel-dot`,e.style.left=`${5+Math.random()*90}%`,e.style.top=`${10+Math.random()*70}%`,e.style.animationDuration=`${.8+Math.random()*1.5}s`,e.style.animationDelay=`${Math.random()*2}s`,d.appendChild(e)}else if(i===`ghost`)for(let e=0;e<12;e++){let e=document.createElement(`div`);e.className=`ghost-bar`,e.style.top=`${Math.random()*100}%`,e.style.width=`${10+Math.random()*30}%`,e.style.animationDuration=`${1.5+Math.random()*3}s`,e.style.animationDelay=`${Math.random()*3}s`,d.appendChild(e)}else{let e=document.createElement(`div`);e.className=`mini-standby-label`,e.textContent=`STANDBY`,d.appendChild(e)}}function Ke(){a=!0,te.style.display=`flex`,d.classList.add(`active`),ze(i),Ge()}setInterval(()=>{let e=document.getElementById(`sys-time`);e&&(e.innerText=`SYS.TIME: ${new Date().toLocaleTimeString()}`)},1e3);var g=null;function qe(e,t,n,r){let i=!1,a=[],o=(e,t)=>{let n=setTimeout(()=>{i||e()},t);return a.push(n),n};e.style.display=`flex`,t.innerHTML=``;let s=150;return n.forEach((e,r)=>{o(()=>{let i=document.createElement(`div`);if(i.textContent=e,i.classList.add(`visible`),t.appendChild(i),r===n.length-1){let e=document.createElement(`div`);e.className=`plab-load-bar`,t.appendChild(e)}},s),s+=250}),o(()=>{e.style.display=`none`,r()},s+600),()=>{i=!0,a.forEach(clearTimeout),a.length=0,e.style.display=`none`}}var Je=[`> EXEC sys_monitor.exe`,`> POLLING HARDWARE INTERFACES...`,`> LOADING PROCESS TABLE...`,`> SENSORS ONLINE.`];function Ye(){let e=document.getElementById(`layer-sysmon`),t=document.getElementById(`sysmon-loading`),n=document.getElementById(`sysmon-loading-text`),r=document.getElementById(`sysmon-app`);pe(`layer-sysmon`),e.style.display=`flex`,r.style.display=`none`,g&&=(g(),null),g=qe(t,n,Je,()=>{g=null,r.style.display=`flex`,ze(i)})}function Xe(){g&&=(g(),null),document.getElementById(`layer-sysmon`).style.display=`none`,he(`layer-sysmon`)}function Ze(e){pe(`layer-placeholder`),document.getElementById(`placeholder-name`).textContent=e,document.getElementById(`layer-placeholder`).style.display=`block`}function Qe(){document.getElementById(`layer-placeholder`).style.display=`none`,he(`layer-placeholder`)}fe(),Pe(),window.rememberFocusForLayer=pe,window.restoreFocusForLayer=he,window.appBootAnimation=qe,window.changeTheme=Ce,window.toggleLightMode=Te,window.changeProtocol=ze,window.toggleBugReport=Ne,window.cancelBugReport=je,window.closeSysMon=Xe,window.closeAppsFolder=le,window.closeDocsFolder=de,window.closePlaceholder=Qe,document.getElementById(`bug-report-send`)?.addEventListener(`click`,Re);var _=document.getElementById(`particleCanvas`),v=_.getContext(`2d`),$e=document.getElementById(`plab-canvas-wrap`),et=document.getElementById(`layer-particle-lab`),tt=document.getElementById(`plab-loading`),nt=document.getElementById(`plab-loading-text`),rt=document.getElementById(`plab-app`),y={mode:`plexus`,amount:150,size:3,speed:1.5,gravity:0,repelStrength:1.5,trails:0,shape:`circle`,colormode:`solid`,color:`#00ffcc`},b=[],x=100,S=100,it=!1,C=null,w=null,at=null,ot=null,st=320,ct=320,T={x:-1e3,y:-1e3,leftDown:!1,rightDown:!1,attractRadius:150};_.addEventListener(`mousedown`,e=>{e.button===0&&(T.leftDown=!0),e.button===2&&(T.rightDown=!0)}),_.addEventListener(`mouseup`,e=>{e.button===0&&(T.leftDown=!1),e.button===2&&(T.rightDown=!1)}),_.addEventListener(`mousemove`,e=>{let t=_.getBoundingClientRect();T.x=e.clientX-t.left,T.y=e.clientY-t.top}),_.addEventListener(`mouseleave`,()=>{T.leftDown=!1,T.rightDown=!1,T.x=-1e3}),_.addEventListener(`contextmenu`,e=>e.preventDefault());function lt(){x=$e.clientWidth,S=$e.clientHeight,_.width=x,_.height=S}function E(e,t){return Math.random()*(t-e)+e}var ut=[`#00ffcc`,`#ff00ff`,`#00ff00`,`#ffff00`,`#ff3300`,`#0066ff`];function dt(){return ut[Math.floor(Math.random()*ut.length)]}function ft(e){let t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return t?{r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16)}:{r:0,g:255,b:204}}var pt=class{x;y;vx;vy;baseColor;da;ds;w;constructor(e,t,n){this.x=e||E(0,x),this.y=t||E(0,S);let r=E(0,Math.PI*2),i=n?E(y.speed*2,y.speed*5):E(y.speed*.2,y.speed);this.vx=Math.cos(r)*i,this.vy=Math.sin(r)*i,this.baseColor=dt(),this.da=E(0,Math.PI*2),this.ds=E(.02,.05),this.w=E(.5,1.5)}update(){if(T.leftDown||T.rightDown){let e=T.x-this.x,t=T.y-this.y,n=Math.sqrt(e*e+t*t),r=Math.atan2(t,e);if(T.leftDown&&n<150){let e=(150-n)/150;this.vx-=Math.cos(r)*e*y.repelStrength,this.vy-=Math.sin(r)*e*y.repelStrength}if(T.rightDown&&n<T.attractRadius){let e=(T.attractRadius-n)/T.attractRadius;this.vx+=Math.cos(r)*e*.8,this.vy+=Math.sin(r)*e*.8}}if(y.mode===`snow`)this.y+=y.speed*.5*this.w+y.gravity,this.x+=Math.sin(this.da)*(y.speed*.5),this.da+=this.ds,this.y>S+y.size?(this.y=-y.size,this.x=E(0,x)):this.y<-y.size&&y.gravity<0&&(this.y=S+y.size,this.x=E(0,x)),this.x>x+y.size&&(this.x=-y.size),this.x<-y.size&&(this.x=x+y.size);else if(y.mode===`vortex`){let e=x/2,t=S/2,n=e-this.x,r=t-this.y,i=Math.sqrt(n*n+r*r),a=Math.atan2(r,n),o=a+Math.PI/2,s=y.gravity,c=y.speed*1.5,l=Math.cos(o)*c+Math.cos(a)*s*5,u=Math.sin(o)*c+Math.sin(a)*s*5;if(this.vx+=(l-this.vx)*.05,this.vy+=(u-this.vy)*.05,this.x+=this.vx,this.y+=this.vy,i<10&&s>0){let n=E(0,Math.PI*2),r=Math.max(x,S)/1.5;this.x=e+Math.cos(n)*r,this.y=t+Math.sin(n)*r}else if(i>Math.max(x,S)&&s<0){let n=E(0,Math.PI*2);this.x=e+Math.cos(n)*20,this.y=t+Math.sin(n)*20}}else if(y.mode===`liquid`){this.vy+=y.gravity,this.x+=this.vx,this.y+=this.vy;let e=b.length>st?Math.ceil(b.length/st):1;for(let t=0;t<b.length;t+=e){let e=b[t];if(e===this)continue;let n=e.x-this.x,r=e.y-this.y,i=Math.sqrt(n*n+r*r);if(i<y.size*4&&i>0)if(i<y.size*2){let e=(y.size*2-i)*.05;this.vx-=n/i*e,this.vy-=r/i*e}else{let e=(i-y.size*2)*.005;this.vx+=n/i*e,this.vy+=r/i*e}}this.vx*=.98,this.vy*=.99,this.x<0&&(this.x=0,this.vx*=-.5),this.x>x&&(this.x=x,this.vx*=-.5),this.y<0&&(this.y=0,this.vy*=-.5),this.y>S&&(this.y=S,this.vy*=-.3,this.vx*=.8)}else{this.vy+=y.gravity,this.x+=this.vx,this.y+=this.vy;let e=Math.sqrt(this.vx*this.vx+this.vy*this.vy);e>y.speed*2&&y.gravity===0&&!T.leftDown&&!T.rightDown?(this.vx*=.95,this.vy*=.95):e<y.speed*.5&&y.gravity===0&&y.speed>0&&(this.vx*=1.05,this.vy*=1.05),this.x<0&&(this.x=0,this.vx*=-1),this.x>x&&(this.x=x,this.vx*=-1),this.y<0&&(this.y=0,this.vy*=-1),this.y>S&&(this.y=S,this.vy*=-.8,y.gravity>0&&(this.vx*=.98))}}draw(){let e=y.color,t=Math.sqrt(this.vx*this.vx+this.vy*this.vy);if(y.colormode===`random`)e=this.baseColor;else if(y.colormode===`velocity`){let n=y.mode===`snow`?y.speed*.5*this.w:t;e=`hsl(${Math.min(280,n*25)},100%,50%)`}v.fillStyle=e,v.beginPath();let n=y.size;if(y.shape===`square`)v.rect(this.x-n/2,this.y-n/2,n,n);else if(y.shape===`circle`)v.arc(this.x,this.y,n/2,0,Math.PI*2);else if(y.shape===`triangle`){let e=Math.atan2(this.vy,this.vx);v.translate(this.x,this.y),v.rotate(e),v.moveTo(n,0),v.lineTo(-n/2,n/2),v.lineTo(-n/2,-n/2),v.rotate(-e),v.translate(-this.x,-this.y)}else if(y.shape===`star`){let e=n,t=n/2,r=Math.PI/2*3,i=Math.PI/5;v.moveTo(this.x,this.y-e);for(let n=0;n<5;n++)v.lineTo(this.x+Math.cos(r)*e,this.y+Math.sin(r)*e),r+=i,v.lineTo(this.x+Math.cos(r)*t,this.y+Math.sin(r)*t),r+=i}v.fill()}};function mt(){for(;b.length<y.amount;)b.push(new pt);b.length>y.amount&&b.splice(y.amount)}function ht(){if(!it)return;T.rightDown?T.attractRadius=Math.min(T.attractRadius+5,Math.max(x,S)):T.attractRadius=150;let e=1-y.trails;e<.01&&(e=.01),v.fillStyle=`rgba(0,0,0,${e})`,v.fillRect(0,0,x,S);for(let e=0;e<b.length;e++)b[e].update(),b[e].draw();if(y.mode===`plexus`){let e=ft(y.color),t=b.length>ct?Math.ceil(b.length/ct):1;for(let n=0;n<b.length;n+=t)for(let r=n+t;r<b.length;r+=t){let t=b[n].x-b[r].x,i=b[n].y-b[r].y,a=Math.sqrt(t*t+i*i);a<120&&(v.beginPath(),v.strokeStyle=`rgba(${e.r},${e.g},${e.b},${1-a/120})`,v.lineWidth=1,v.moveTo(b[n].x,b[n].y),v.lineTo(b[r].x,b[r].y),v.stroke())}}C=requestAnimationFrame(ht)}function D(e,t,n){let r=document.getElementById(`ctrl-${e}`),i=document.getElementById(`val-${e}`);r.addEventListener(`input`,()=>{let e=n?parseFloat(r.value):parseInt(r.value,10);Number.isNaN(e)||(y[t]=e,i&&(i.textContent=String(y[t])),t===`amount`&&mt())})}D(`amount`,`amount`),D(`size`,`size`),D(`speed`,`speed`,!0),D(`gravity`,`gravity`,!0),D(`trails`,`trails`,!0),D(`repel`,`repelStrength`,!0),document.getElementById(`ctrl-shape`).addEventListener(`change`,e=>{y.shape=e.target.value}),document.getElementById(`ctrl-colormode`).addEventListener(`change`,e=>{y.colormode=e.target.value,document.getElementById(`solid-color-group`).style.display=y.colormode===`solid`?`flex`:`none`}),document.getElementById(`ctrl-color`).addEventListener(`input`,e=>{y.color=e.target.value}),document.getElementById(`btn-explode`).addEventListener(`click`,()=>{let e=x/2,t=S/2;b.forEach(n=>{n.x=e,n.y=t;let r=E(0,Math.PI*2),i=E(5,20);n.vx=Math.cos(r)*i,n.vy=Math.sin(r)*i})});var O=document.getElementById(`btn-snow`),k=document.getElementById(`btn-vortex`),A=document.getElementById(`btn-plexus`),j=document.getElementById(`btn-liquid`);function M(e,t,n){y[e]=t;let r=document.getElementById(`ctrl-${e}`);if(r&&(r.value=String(t)),n!=null){let t=document.getElementById(`val-${e}`);t&&(t.textContent=String(n))}e===`amount`&&mt()}function gt(e){y.mode=e,O.classList.remove(`active`),O.textContent=`Snow`,k.classList.remove(`active`),k.textContent=`Vortex`,A.classList.remove(`active`),A.textContent=`Plexus`,j.classList.remove(`active`),j.textContent=`Liquid`,_.classList.remove(`gooey-effect`);let t=document.getElementById(`ctrl-size`);t&&(t.disabled=!1);let n=document.getElementById(`ctrl-shape`),r=document.getElementById(`ctrl-colormode`),i=document.getElementById(`ctrl-color`),a=document.getElementById(`solid-color-group`);e===`snow`?(O.classList.add(`active`),O.textContent=`✓ Snow`,M(`shape`,`circle`),n.value=`circle`,M(`colormode`,`solid`),r.value=`solid`,a.style.display=`flex`,M(`color`,`#ffffff`),i.value=`#ffffff`,M(`gravity`,0,`0`),M(`speed`,3,`3`),M(`trails`,.5,`0.5`)):e===`vortex`?(k.classList.add(`active`),k.textContent=`✓ Vortex`,M(`shape`,`triangle`),n.value=`triangle`,M(`colormode`,`velocity`),r.value=`velocity`,a.style.display=`none`,M(`gravity`,.5,`0.5`),M(`speed`,6,`6`),M(`trails`,.9,`0.9`)):e===`plexus`?(A.classList.add(`active`),A.textContent=`✓ Plexus`,M(`amount`,150,`150`),M(`shape`,`circle`),n.value=`circle`,M(`colormode`,`solid`),r.value=`solid`,a.style.display=`flex`,M(`color`,`#00ffcc`),i.value=`#00ffcc`,M(`gravity`,0,`0`),M(`speed`,1.5,`1.5`),M(`trails`,0,`0`)):e===`liquid`?(j.classList.add(`active`),j.textContent=`✓ Liquid`,_.classList.add(`gooey-effect`),M(`amount`,100,`100`),M(`size`,20,`20`),M(`shape`,`circle`),n.value=`circle`,M(`colormode`,`solid`),r.value=`solid`,a.style.display=`flex`,M(`color`,`#00aaff`),i.value=`#00aaff`,M(`gravity`,.5,`0.5`),M(`speed`,2,`2`),M(`trails`,0,`0`),t&&(t.disabled=!0)):(M(`shape`,`circle`),n.value=`circle`,M(`colormode`,`solid`),r.value=`solid`,a.style.display=`flex`,M(`color`,`#00ffcc`),i.value=`#00ffcc`,M(`gravity`,0,`0`),M(`speed`,1.5,`1.5`),M(`trails`,0,`0`),M(`amount`,150,`150`),b.forEach(e=>{let t=E(0,Math.PI*2),n=E(y.speed*.2,y.speed);e.vx=Math.cos(t)*n,e.vy=Math.sin(t)*n}))}O.addEventListener(`click`,()=>gt(y.mode===`snow`?`normal`:`snow`)),k.addEventListener(`click`,()=>gt(y.mode===`vortex`?`normal`:`vortex`)),A.addEventListener(`click`,()=>gt(y.mode===`plexus`?`normal`:`plexus`)),j.addEventListener(`click`,()=>gt(y.mode===`liquid`?`normal`:`liquid`));var N=[],_t=document.getElementById(`ctrl-presets`);document.getElementById(`btn-save-preset`).addEventListener(`click`,()=>{N.push(JSON.parse(JSON.stringify(y)));let e=N.length-1;N.length===1&&(_t.innerHTML=``);let t=document.createElement(`option`);t.value=String(e),t.textContent=`Preset ${e+1}`,_t.appendChild(t),_t.value=String(e);let n=document.getElementById(`btn-save-preset`),r=n.textContent;n.textContent=`Saved!`,setTimeout(()=>n.textContent=r,1e3)}),document.getElementById(`btn-load-preset`).addEventListener(`click`,()=>{let e=parseInt(_t.value,10);!Number.isNaN(e)&&e>=0&&e<N.length&&N[e]&&(Object.assign(y,JSON.parse(JSON.stringify(N[e]))),M(`amount`,y.amount,y.amount),M(`size`,y.size,y.size),M(`speed`,y.speed,y.speed),M(`gravity`,y.gravity,y.gravity),M(`repel`,y.repelStrength,y.repelStrength),M(`trails`,y.trails,y.trails),document.getElementById(`ctrl-shape`).value=y.shape,document.getElementById(`ctrl-colormode`).value=y.colormode,document.getElementById(`ctrl-color`).value=y.color,document.getElementById(`solid-color-group`).style.display=y.colormode===`solid`?`flex`:`none`,[[`snow`,O],[`vortex`,k],[`plexus`,A],[`liquid`,j]].forEach(([e,t])=>{t.classList.toggle(`active`,y.mode===e),t.textContent=y.mode===e?`\u2713 ${e[0].toUpperCase()+e.slice(1)}`:e[0].toUpperCase()+e.slice(1)}),y.mode===`liquid`?(_.classList.add(`gooey-effect`),y.size=20,M(`size`,20,`20`),document.getElementById(`ctrl-size`).disabled=!0):(_.classList.remove(`gooey-effect`),document.getElementById(`ctrl-size`).disabled=!1))});var vt=[`> EXEC particle_lab.exe`,`> LOADING RENDER ENGINE... [OK]`,`> ALLOCATING PARTICLE BUFFER...`,`> LINKING PHYSICS SUBSYSTEM...`,`> DISPLAY READY.`];function yt(){typeof rememberFocusForLayer==`function`&&rememberFocusForLayer(`layer-particle-lab`),et.style.display=`flex`,rt.style.display=`none`,w&&=(w(),null),at||(at=()=>{it&&lt()},window.addEventListener(`resize`,at)),ot||(ot=()=>{if(it){if(document.hidden){C&&cancelAnimationFrame(C),C=null;return}C||ht()}},document.addEventListener(`visibilitychange`,ot)),w=appBootAnimation(tt,nt,vt,()=>{w=null,rt.style.display=`flex`,it=!0,y.mode===`liquid`&&_.classList.add(`gooey-effect`),requestAnimationFrame(()=>{lt(),mt(),ht()})})}function bt(){try{w&&=(w(),null),et.style.display=`none`,_.classList.remove(`gooey-effect`),typeof restoreFocusForLayer==`function`&&restoreFocusForLayer(`layer-particle-lab`)}finally{it=!1,C&&cancelAnimationFrame(C),C=null,at&&=(window.removeEventListener(`resize`,at),null),ot&&=(document.removeEventListener(`visibilitychange`,ot),null)}}function xt(){document.getElementById(`plab-controls`).classList.toggle(`collapsed`)}window.launchParticleLab=yt,window.closeParticleLab=bt,window.togglePlabControls=xt;var P=null,St=[`> EXEC resource_router.exe`,`> CONNECTING TO GLOBAL NETWORK...`,`> NO ROUTES CONFIGURED.`,`> AWAITING OPERATOR INPUT.`];function Ct(){let e=document.getElementById(`layer-resource-router`),t=document.getElementById(`router-loading`),n=document.getElementById(`router-loading-text`),r=document.getElementById(`router-app`);typeof rememberFocusForLayer==`function`&&rememberFocusForLayer(`layer-resource-router`),e.style.display=`flex`,r.style.display=`none`,P&&=(P(),null),P=appBootAnimation(t,n,St,()=>{P=null,r.style.display=`flex`})}function wt(){P&&=(P(),null),document.getElementById(`layer-resource-router`).style.display=`none`,typeof restoreFocusForLayer==`function`&&restoreFocusForLayer(`layer-resource-router`)}window.launchResourceRouter=Ct,window.closeResourceRouter=wt;var F=document.getElementById(`beeSimCanvas`),I=F.getContext(`2d`),Tt=document.getElementById(`beesim-canvas-wrap`),Et=document.getElementById(`layer-beesim`),Dt=document.getElementById(`beesim-app`),Ot=document.getElementById(`beesim-loading`),kt=document.getElementById(`beesim-loading-text`),At=!1,L=null,R=null,jt=null,Mt=null,Nt=75,z=13,B=5,Pt=Math.PI*.75,Ft=4,V,H,U={};[`bee-cohesion`,`bee-alignment`,`bee-separation`,`bee-speed`,`bee-vision`].forEach(e=>{let t=document.getElementById(e),n=document.getElementById(e+`Val`),r=e.replace(`bee-`,``);U[r]={el:t,get value(){return+t.value}},t.addEventListener(`input`,()=>{n.textContent=t.value})});var It=document.getElementById(`bee-showVision`),W={x:-9999,y:-9999,active:!1,repel:!1};F.addEventListener(`mousemove`,e=>{let t=F.getBoundingClientRect();W.x=e.clientX-t.left,W.y=e.clientY-t.top}),F.addEventListener(`mousedown`,e=>{e.preventDefault(),W.active=!0,W.repel=e.button===2}),F.addEventListener(`mouseup`,()=>{W.active=!1}),F.addEventListener(`contextmenu`,e=>e.preventDefault()),F.addEventListener(`touchstart`,e=>{let t=e.touches[0],n=F.getBoundingClientRect();W.x=t.clientX-n.left,W.y=t.clientY-n.top,W.active=!0},{passive:!0}),F.addEventListener(`touchmove`,e=>{let t=e.touches[0],n=F.getBoundingClientRect();W.x=t.clientX-n.left,W.y=t.clientY-n.top},{passive:!0}),F.addEventListener(`touchend`,()=>{W.active=!1});function Lt(e,t){let n=e.x-t.x,r=e.y-t.y;return n*n+r*r}function Rt(e,t){let n=Lt(e,t);return n===0?0:Math.sqrt(n)}var G=[];function zt(e,t,n){G.length>400||G.push({x:e,y:t,vx:(Math.random()-.5)*1.5,vy:-Math.random()*1.2-.3,life:20+Math.random()*25,maxLife:45,size:1+Math.random()*2,type:n})}function Bt(){for(let e=G.length-1;e>=0;e--){let t=G[e];t.x+=t.vx,t.y+=t.vy,t.vy-=.01,t.vx*=.98,--t.life<=0&&G.splice(e,1)}}function Vt(){for(let e of G){let t=e.life/e.maxLife;I.fillStyle=e.type===`honey`?`rgba(255,180,40,${t*.8})`:`rgba(255,220,60,${t*.7})`,I.beginPath(),I.arc(e.x,e.y,e.size*t,0,Math.PI*2),I.fill()}}var K=[],q={x:0,y:0},Ht=0;function Ut(){K=[];for(let e=-B;e<=B;e++){let t=Math.max(-B,-e-B),n=Math.min(B,-e+B);for(let r=t;r<=n;r++)K.push({q:e,r,x:0,y:0,beeIndex:-1,honey:0})}K.sort((e,t)=>e.q*e.q+e.r*e.r+e.q*e.r-(t.q*t.q+t.r*t.r+t.q*t.r));for(let e=Nt;e<K.length;e++)K[e].honey=.4+Math.random()*.6}function Wt(){let e=z*B*1.8;V<600?(q.x=V/2,q.y=e+20):(q.x=V-e-35,q.y=e+45);for(let e of K)e.x=q.x+z*1.5*e.q,e.y=q.y+z*(Math.sqrt(3)/2*e.q+Math.sqrt(3)*e.r)}function Gt(e,t,n){I.beginPath();for(let r=0;r<6;r++){let i=Math.PI/3*r,a=e+n*Math.cos(i),o=t+n*Math.sin(i);r===0?I.moveTo(a,o):I.lineTo(a,o)}I.closePath()}function Kt(e){let t=z*(B+3)*1.7,n=I.createRadialGradient(q.x,q.y,t*.15,q.x,q.y,t);n.addColorStop(0,`rgba(255,170,40,0.12)`),n.addColorStop(.6,`rgba(255,140,20,0.04)`),n.addColorStop(1,`rgba(255,140,20,0)`),I.fillStyle=n,I.beginPath(),I.arc(q.x,q.y,t,0,Math.PI*2),I.fill(),Ht=0;for(let t=0;t<K.length;t++){let n=K[t];Ht+=n.honey;let r=n.beeIndex>=0?Y[n.beeIndex]:null,i=r&&r.state===`sleeping`;if(Gt(n.x,n.y,z-1.5),i)I.fillStyle=`rgba(50,35,8,0.95)`;else{let e=n.honey;I.fillStyle=`rgba(${Math.floor(38+e*185)},${Math.floor(26+e*135)},${Math.floor(8+e*28)},0.9)`}I.fill(),n.honey>.15&&!i&&(Gt(n.x-1.5,n.y-1.5,z*.4*n.honey),I.fillStyle=`rgba(255,235,140,${.06+n.honey*.12})`,I.fill()),n.honey>.85&&(Gt(n.x,n.y,z-2.5),I.fillStyle=`rgba(255,245,180,${.04+Math.sin(e*.05+t)*.025})`,I.fill()),Gt(n.x,n.y,z-.5),I.strokeStyle=`rgba(210,170,60,${.35+n.honey*.2})`,I.lineWidth=1.3,I.stroke(),i&&qt(n.x,n.y,r,e)}let r=Y.filter(e=>e.state===`sleeping`).length,i=Y.filter(e=>e.state===`collecting`).length,a=Y.filter(e=>e.state===`returning`).length,o=Nt-r-i-a;I.fillStyle=`rgba(240,220,140,0.55)`,I.font=`11px Segoe UI, sans-serif`,I.textAlign=`center`;let s=q.y+z*B*Math.sqrt(3)+18;I.fillText(`Honey: ${Ht.toFixed(1)} · Flying ${o} · Collecting ${i} · Returning ${a} · Sleeping ${r}`,q.x,s)}function qt(e,t,n,r){I.save(),I.translate(e,t);let i=I.createLinearGradient(-4,0,4,0);i.addColorStop(0,`#b8860b`),i.addColorStop(.4,`#ffd700`),i.addColorStop(.55,`#2a1800`),i.addColorStop(.7,`#ffd700`),i.addColorStop(1,`#daa520`),I.beginPath(),I.ellipse(0,0,5,3.2,0,0,Math.PI*2),I.fillStyle=i,I.fill(),I.globalAlpha=.25,I.fillStyle=`rgba(190,210,255,1)`,I.beginPath(),I.ellipse(-1,-3,3,1.8,-.3,0,Math.PI*2),I.fill(),I.beginPath(),I.ellipse(-1,3,3,1.8,.3,0,Math.PI*2),I.fill(),I.globalAlpha=1,n.cargo>0&&(I.fillStyle=`rgba(255,200,40,0.6)`,I.beginPath(),I.ellipse(-1,-4.5,2,1.4,0,0,Math.PI*2),I.fill(),I.beginPath(),I.ellipse(-1,4.5,2,1.4,0,0,Math.PI*2),I.fill());let a=n.sleepTimer||0;I.fillStyle=`rgba(180,190,255,${.3+.25*Math.sin(a*.06)})`,I.font=`bold 8px sans-serif`,I.textAlign=`left`;let o=-6-Math.sin(a*.04)*2;I.fillText(`z`,3,o),I.font=`bold 6px sans-serif`,I.fillText(`z`,7,o-5);let s=n.stamina/n.maxStamina;I.beginPath(),I.arc(0,0,7,-Math.PI/2,-Math.PI/2+Math.PI*2*s),I.strokeStyle=`rgba(120,255,120,${.2+s*.15})`,I.lineWidth=1.2,I.stroke(),I.restore()}var J=[];function Jt(){J=[];let e=Math.max(7,Math.min(14,Math.floor(V*H/75e3)));for(let t=0;t<e;t++){let e,t,n=0;do e=40+Math.random()*(V-80),t=60+Math.random()*(H-120),n++;while(n<60&&Rt({x:e,y:t},q)<z*B*3);let r=5+Math.random()*5;J.push({x:e,y:t,nectar:r*(.4+Math.random()*.6),maxNectar:r,regen:.0025+Math.random()*.002,size:14+Math.random()*10,hue:[45,340,300,25,15,55,195][Math.floor(Math.random()*7)],petals:5+Math.floor(Math.random()*4),phase:Math.random()*Math.PI*2})}}function Yt(){for(let e of J)e.nectar<e.maxNectar&&(e.nectar=Math.min(e.maxNectar,e.nectar+e.regen))}function Xt(e){for(let t of J){let n=t.nectar/t.maxNectar;if(I.save(),I.translate(t.x,t.y),I.rotate(Math.sin(e*.015+t.phase)*.04),n>.05){let e=t.size*2+n*t.size,r=I.createRadialGradient(0,0,2,0,0,e);r.addColorStop(0,`hsla(${t.hue},80%,60%,${n*.07})`),r.addColorStop(1,`hsla(${t.hue},80%,60%,0)`),I.fillStyle=r,I.beginPath(),I.arc(0,0,e,0,Math.PI*2),I.fill()}I.beginPath(),I.moveTo(0,t.size*.3),I.quadraticCurveTo(2,t.size*1.2,0,t.size*2),I.strokeStyle=`rgba(60,130,40,${.2+n*.2})`,I.lineWidth=2,I.stroke(),I.save(),I.translate(1,t.size*1.1),I.rotate(.3),I.beginPath(),I.ellipse(6,0,7,3,.2,0,Math.PI*2),I.fillStyle=`rgba(50,120,35,${.15+n*.1})`,I.fill(),I.restore();let r=t.size*(.38+n*.15),i=.18+n*.38;for(let a=0;a<t.petals;a++)I.save(),I.rotate(Math.PI*2/t.petals*a+Math.sin(e*.02+t.phase)*.02),I.beginPath(),I.ellipse(t.size*.55,0,r,r*.48,0,0,Math.PI*2),I.fillStyle=`hsla(${t.hue},75%,${48+n*15}%,${i})`,I.fill(),I.strokeStyle=`hsla(${t.hue},60%,38%,${i*.4})`,I.lineWidth=.5,I.stroke(),I.restore();I.beginPath(),I.arc(0,0,t.size*.25,0,Math.PI*2);let a=I.createRadialGradient(0,0,0,0,0,t.size*.25);a.addColorStop(0,`rgba(255,220,60,${.35+n*.35})`),a.addColorStop(1,`rgba(200,160,40,${.25+n*.25})`),I.fillStyle=a,I.fill(),I.beginPath(),I.arc(0,0,t.size*.35,-Math.PI/2,-Math.PI/2+Math.PI*2*n),I.strokeStyle=`rgba(255,230,100,${.15+n*.4})`,I.lineWidth=2,I.stroke(),I.restore()}}var Zt=class{index;x;y;vx;vy;wingPhase;wobble;stamina;maxStamina;drainRate;rechargeRate;tiredAt;wakeAt;state;cellIndex;sleepTimer;cargo;targetFlower;collectTimer;collectDuration;constructor(e){this.index=e,this.x=100+Math.random()*400,this.y=100+Math.random()*300;let t=Math.random()*Math.PI*2;this.vx=Math.cos(t)*2,this.vy=Math.sin(t)*2,this.wingPhase=Math.random()*Math.PI*2,this.wobble=Math.random()*Math.PI*2,this.stamina=50+Math.random()*50,this.maxStamina=100,this.drainRate=.02+Math.random()*.022,this.rechargeRate=.16+Math.random()*.1,this.tiredAt=15+Math.random()*10,this.wakeAt=82+Math.random()*18,this.state=`foraging`,this.cellIndex=-1,this.sleepTimer=0,this.cargo=0,this.targetFlower=null,this.collectTimer=0,this.collectDuration=65+Math.random()*50}get cell(){return this.cellIndex>=0?K[this.cellIndex]:null}canSee(e){let t=e.x-this.x,n=e.y-this.y,r=t*t+n*n,i=U.vision.value;if(r>i*i||r<.01)return!1;let a=Math.atan2(this.vy,this.vx),o=Math.atan2(n,t)-a;return o>Math.PI&&(o-=Math.PI*2),o<-Math.PI&&(o+=Math.PI*2),Math.abs(o)<Pt}update(e,t){if(this.state===`sleeping`){if(this.sleepTimer++,this.stamina=Math.min(this.maxStamina,this.stamina+this.rechargeRate),this.cargo>0){let e=Math.min(this.cargo,.008);this.cargo-=e;let n=this.cell;if(n&&(n.honey=Math.min(1,n.honey+e*.85)),this.cargo<.01&&(this.cargo=0,t%12==0)){let e=this.cell;e&&zt(e.x+(Math.random()-.5)*6,e.y+(Math.random()-.5)*6,`honey`)}}if(this.stamina>=this.wakeAt&&this.cargo<=0){this.state=`foraging`;let e=this.cell;if(e){this.x=e.x,this.y=e.y;let t=Math.atan2(e.y-q.y,e.x-q.x)+(Math.random()-.5)*1;this.vx=Math.cos(t)*3,this.vy=Math.sin(t)*3}this.targetFlower=null}return}let n=U.speed.value/15;if(this.state===`collecting`){if(this.collectTimer--,this.stamina-=this.drainRate*.2,this.targetFlower){let e=this.targetFlower;this.x+=(e.x-this.x)*.1,this.y+=(e.y-this.y)*.1,this.x+=Math.sin(t*.08+this.index*2.3)*.7,this.y+=Math.cos(t*.08+this.index*2.3)*.7,t%7==0&&zt(this.x+(Math.random()-.5)*8,this.y+(Math.random()-.5)*8,`pollen`)}if(this.collectTimer<=0||this.stamina<=this.tiredAt*.5){if(this.targetFlower&&this.targetFlower.nectar>.05){let e=Math.min(1,this.targetFlower.nectar);this.cargo=e,this.targetFlower.nectar-=e}this.state=`returning`,this.targetFlower=null;let e=this.cell;if(e){let t=e.x-this.x,r=e.y-this.y,i=Math.sqrt(t*t+r*r)||1;this.vx=t/i*n,this.vy=r/i*n}}this.wingPhase+=.25;return}if(this.state===`foraging`)if(this.stamina-=this.drainRate,this.stamina<=this.tiredAt)this.state=`returning`,this.targetFlower=null;else{this.applyBoids(e),this.applyMouse(),this.seekFlower();for(let t of J)if(!(t.nectar<.3)&&Rt(this,t)<18){let n=0;for(let r of e)r.state===`collecting`&&r.targetFlower===t&&n++;if(n<Ft){this.state=`collecting`,this.targetFlower=t,this.collectTimer=this.collectDuration;break}}}if(this.state===`returning`){this.stamina-=this.drainRate*.35;let t=this.cell;if(t){let e=t.x-this.x,n=t.y-this.y,r=Math.sqrt(e*e+n*n);if(r<8){if(this.cargo>0)for(let e=0;e<3;e++)zt(t.x+(Math.random()-.5)*8,t.y+(Math.random()-.5)*8,`honey`);this.state=`sleeping`,this.x=t.x,this.y=t.y,this.vx=0,this.vy=0,this.sleepTimer=0;return}this.vx+=e/r*.5,this.vy+=n/r*.5}this.applySep(e,.3)}let r=.3;this.x<40&&(this.vx+=r),this.x>V-40&&(this.vx-=r),this.y<40&&(this.vy+=r),this.y>H-40&&(this.vy-=r),this.wobble+=.08;let i=this.state===`returning`?.015:.04;this.vx+=Math.sin(this.wobble)*i,this.vy+=Math.cos(this.wobble*1.3)*i;let a=Math.sqrt(this.vx*this.vx+this.vy*this.vy),o=this.state===`returning`?n*1.25:n;a>o?(this.vx=this.vx/a*o,this.vy=this.vy/a*o):a<o*.2&&a>.01&&(this.vx=this.vx/a*o*.2,this.vy=this.vy/a*o*.2),this.x+=this.vx,this.y+=this.vy,this.wingPhase+=.5,this.stamina=Math.max(0,this.stamina)}seekFlower(){let e=null,t=-1/0;for(let n of J){if(n.nectar<.4)continue;let r=Rt(this,n);if(r>600)continue;let i=n.nectar/n.maxNectar*.6-r/500;i>t&&(t=i,e=n)}if(e){this.targetFlower=e;let t=e.x-this.x,n=e.y-this.y,r=Math.sqrt(t*t+n*n)||1;this.vx+=t/r*.13,this.vy+=n/r*.13}}applyBoids(e){let t=U.cohesion.value/1e3,n=U.alignment.value/1e3,r=U.separation.value/100,i=0,a=0,o=0,s=0,c=0,l=0,u=0;for(let t of e){if(t===this||t.state===`sleeping`||t.state===`collecting`||!this.canSee(t))continue;let e=t.x-this.x,n=t.y-this.y,r=Math.sqrt(e*e+n*n);u++,i+=t.x,a+=t.y,o+=t.vx,s+=t.vy,r<28&&r>.01&&(c-=e/r*(28-r),l-=n/r*(28-r))}u>0&&(this.vx+=(i/u-this.x)*t,this.vy+=(a/u-this.y)*t,this.vx+=(o/u-this.vx)*n,this.vy+=(s/u-this.vy)*n,this.vx+=c*r,this.vy+=l*r)}applySep(e,t){let n=U.separation.value/100*t,r=0,i=0;for(let t of e){if(t===this||t.state===`sleeping`)continue;let e=t.x-this.x,n=t.y-this.y,a=Math.sqrt(e*e+n*n);a<24&&a>.01&&(r-=e/a*(24-a),i-=n/a*(24-a))}this.vx+=r*n,this.vy+=i*n}applyMouse(){if(!W.active)return;let e=W.x-this.x,t=W.y-this.y,n=Math.sqrt(e*e+t*t);if(n<200&&n>1){let r=W.repel?-.9:.35;this.vx+=e/n*r,this.vy+=t/n*r}}draw(e){if(this.state===`sleeping`)return;let t=Math.atan2(this.vy,this.vx);It.checked&&this.state===`foraging`&&(I.save(),I.translate(this.x,this.y),I.rotate(t),I.beginPath(),I.moveTo(0,0),I.arc(0,0,U.vision.value,-Pt,Pt),I.closePath(),I.fillStyle=`rgba(240,230,140,0.03)`,I.fill(),I.restore()),I.save(),I.translate(this.x,this.y),this.state===`collecting`?I.rotate(t+Math.sin(e*.12)*.3):I.rotate(t);let n=Math.sin(this.wingPhase)*.5;I.fillStyle=`rgba(200,220,255,0.4)`,I.strokeStyle=`rgba(180,200,240,0.4)`,I.lineWidth=.4,I.beginPath(),I.ellipse(-2,-5,4,7,n-.3,0,Math.PI*2),I.fill(),I.stroke(),I.beginPath(),I.ellipse(-2,5,4,7,-n+.3,0,Math.PI*2),I.fill(),I.stroke();let r=I.createLinearGradient(-9,0,3,0);r.addColorStop(0,`#b8860b`),r.addColorStop(.3,`#ffd700`),r.addColorStop(.5,`#1a1000`),r.addColorStop(.7,`#ffd700`),r.addColorStop(1,`#daa520`),I.beginPath(),I.ellipse(-3,0,6,4,0,0,Math.PI*2),I.fillStyle=r,I.fill(),I.strokeStyle=`rgba(100,70,0,0.5)`,I.lineWidth=.4,I.stroke(),I.strokeStyle=`rgba(30,15,0,0.5)`,I.lineWidth=1.1;for(let e=-2;e<=3;e+=2.5)I.beginPath(),I.moveTo(-3+e,-3.5),I.lineTo(-3+e,3.5),I.stroke();if(I.beginPath(),I.ellipse(5,0,3,2.8,0,0,Math.PI*2),I.fillStyle=`#daa520`,I.fill(),I.fillStyle=`#1a1000`,I.beginPath(),I.arc(6.5,-1.5,1,0,Math.PI*2),I.fill(),I.beginPath(),I.arc(6.5,1.5,1,0,Math.PI*2),I.fill(),I.strokeStyle=`rgba(100,70,0,0.65)`,I.lineWidth=.6,I.beginPath(),I.moveTo(6,-2),I.quadraticCurveTo(10,-6,12,-5),I.stroke(),I.beginPath(),I.moveTo(6,2),I.quadraticCurveTo(10,6,12,5),I.stroke(),I.beginPath(),I.moveTo(-9,0),I.lineTo(-11,0),I.strokeStyle=`rgba(80,50,0,0.6)`,I.lineWidth=.8,I.stroke(),this.cargo>0){let e=.45+this.cargo*.4;I.fillStyle=`rgba(255,200,40,${e})`,I.beginPath(),I.ellipse(-1,-5.5,2.5,1.8,0,0,Math.PI*2),I.fill(),I.beginPath(),I.ellipse(-1,5.5,2.5,1.8,0,0,Math.PI*2),I.fill(),I.fillStyle=`rgba(255,220,60,${e*.3})`,I.beginPath(),I.ellipse(-1,-5.5,4,3,0,0,Math.PI*2),I.fill(),I.beginPath(),I.ellipse(-1,5.5,4,3,0,0,Math.PI*2),I.fill()}if(I.restore(),this.state!==`collecting`){let e=2.5,t=this.x-16/2,n=this.y-14,r=Math.max(0,this.stamina/this.maxStamina);I.fillStyle=`rgba(0,0,0,0.4)`,I.fillRect(t-.5,n-.5,17,e+1),I.fillStyle=`rgb(${r<.5?255:Math.floor(255*(1-r)*2)},${r>.5?210:Math.floor(210*r*2)},50)`,I.fillRect(t,n,16*r,e),this.state===`returning`&&(I.save(),I.translate(this.x,n-5),this.cargo>0?(I.fillStyle=`rgba(255,200,50,0.8)`,I.beginPath(),I.arc(0,0,2.5,0,Math.PI*2),I.fill()):(I.fillStyle=`rgba(255,200,80,0.6)`,I.beginPath(),I.moveTo(0,-3),I.lineTo(-3,0),I.lineTo(-2,0),I.lineTo(-2,2),I.lineTo(2,2),I.lineTo(2,0),I.lineTo(3,0),I.closePath(),I.fill()),I.restore())}}};function Qt(){let e=I.createRadialGradient(V*.3,H*.6,50,V*.5,H*.5,V*.8);e.addColorStop(0,`#1e3a1e`),e.addColorStop(.5,`#142814`),e.addColorStop(1,`#0a150a`),I.fillStyle=e,I.fillRect(0,0,V,H),I.globalAlpha=.03;for(let e=0;e<200;e++)I.fillStyle=`#4a8a3a`,I.fillRect(e*137.5%V,e*97.3%H,1,3+e%4);I.globalAlpha=1}var Y=[],X=0;function $t(){V=F.width=Tt.offsetWidth,H=F.height=Tt.offsetHeight,Ut(),Y=[];for(let e=0;e<Nt;e++)Y.push(new Zt(e));for(let e=0;e<Nt&&e<K.length;e++)K[e].beeIndex=e,Y[e].cellIndex=e;Wt(),Jt();for(let e of Y){let t=e.cell;t&&(e.stamina>e.tiredAt+15?(e.x=40+V*.6*Math.random(),e.y=80+Math.random()*(H-160)):(e.state=`sleeping`,e.x=t.x,e.y=t.y,e.vx=0,e.vy=0))}G=[],X=0}function en(){V=F.width=Tt.offsetWidth,H=F.height=Tt.offsetHeight,Wt();for(let e of J)Rt(e,q)<z*B*3&&(e.x=40+V*.5*Math.random(),e.y=80+Math.random()*(H-160))}function tn(){if(At){Qt(),Yt(),Xt(X),Kt(X),Bt(),Vt(),W.active&&(I.beginPath(),I.arc(W.x,W.y,14+Math.sin(X*.12)*3,0,Math.PI*2),I.fillStyle=W.repel?`rgba(255,70,70,0.25)`:`rgba(255,230,100,0.25)`,I.fill());for(let e of Y)e.update(Y,X);for(let e of Y)e.draw(X);X++,L=requestAnimationFrame(tn)}}var nn=[`> EXEC bee_colony.exe`,`> SPAWNING AGENTS...`,`> GENERATING FLORA GRID...`,`> HIVE ONLINE.`];function rn(){typeof rememberFocusForLayer==`function`&&rememberFocusForLayer(`layer-beesim`),Et.style.display=`flex`,Dt.style.display=`none`,R&&=(R(),null),jt||(jt=()=>{At&&en()},window.addEventListener(`resize`,jt)),Mt||(Mt=()=>{if(At){if(document.hidden){L&&cancelAnimationFrame(L),L=null;return}L||tn()}},document.addEventListener(`visibilitychange`,Mt)),R=appBootAnimation(Ot,kt,nn,()=>{R=null,Dt.style.display=`flex`,At=!0,requestAnimationFrame(()=>{$t(),tn()})})}function an(){try{R&&=(R(),null),Et.style.display=`none`,typeof restoreFocusForLayer==`function`&&restoreFocusForLayer(`layer-beesim`)}finally{At=!1,L&&cancelAnimationFrame(L),L=null,jt&&=(window.removeEventListener(`resize`,jt),null),Mt&&=(document.removeEventListener(`visibilitychange`,Mt),null)}}function on(){document.getElementById(`beesim-controls`).classList.toggle(`collapsed`)}window.launchBeeSim=rn,window.closeBeeSim=an,window.toggleBeeSimControls=on;var Z=null,sn=[`> EXEC docs_viewer.exe`,`> INDEXING KNOWLEDGE BASE...`,`> DECRYPTING ARCHIVES...`,`> DOCS READY.`];function Q(e,t,n){return`
...
`}];function $(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}var ln=[{id:`plab-overview`,title:`OVERVIEW`,content:`
...
`+Q(`Main Animation Loop`,$(`function plabAnimate() {
    ...
    request next frame`))}],un=[{id:`bee-overview`,title:`OVERVIEW`,content:`
